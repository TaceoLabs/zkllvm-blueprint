#define BOOST_TEST_MODULE blueprint_plonk_fixedpoint_sqrt_test
...
BOOST_AUTO_TEST_CASE(blueprint_plonk_fixedpoint_sqrt_test_vesta) {
...
BOOST_AUTO_TEST_CASE(blueprint_plonk_fixedpoint_sqrt_test_pallas) {
    using field_type = typename crypto3::algebra::curves::pallas::base_field_type;
    field_operations_test<FixedPoint16_16<field_type>, random_tests_amount>();
    field_operations_test<FixedPoint32_32<field_type>, random_tests_amount>();
}

BOOST_AUTO_TEST_CASE(blueprint_plonk_fixedpoint_sqrt_test_bls12) {
