...
// Allows disabling the lookup tables for faster testing
            ...
            template<typename BlueprintFieldType>
            typename plonk_fixedpoint_mul_rescale_const<BlueprintFieldType>::result_type
                generate_assignments(
                    const plonk_fixedpoint_mul_rescale_const<BlueprintFieldType> &component,
                    assignment<crypto3::zk::snark::plonk_constraint_system<BlueprintFieldType>>
                        &assignment,
                    const typename plonk_fixedpoint_mul_rescale_const<BlueprintFieldType>::input_type instance_input,
            ...
            std::size_t generate_gates(
                ...
                assignment<crypto3::zk::snark::plonk_constraint_system<BlueprintFieldType>>
                    &assignment,
                const typename plonk_fixedpoint_mul_rescale_const<BlueprintFieldType>::input_type
                    &instance_input) {

                uint64_t start_row_index = 0;
                const auto var_pos = component.get_var_pos(static_cast<int64_t>(start_row_index));

                using var = typename plonk_fixedpoint_mul_rescale_const<BlueprintFieldType>::var;
            ...
            std::size_t generate_lookup_gates(
                ...
                using range_table =
                    typename plonk_fixedpoint_mul_rescale_const<BlueprintFieldType>::range_table;
