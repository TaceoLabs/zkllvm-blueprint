...
namespace nil {
    namespace blueprint {
        namespace components {
            ...
            class fix_atan<crypto3::zk::snark::plonk_constraint_system<BlueprintFieldType>,
...
// Allows disabling the lookup tables for faster testing
            ...
            typename BlueprintFieldType::value_type generate_assignments_row0(
                const plonk_fixedpoint_atan<BlueprintFieldType> &component,
                assignment<crypto3::zk::snark::plonk_constraint_system<BlueprintFieldType>>
                    &assignment,
                const typename plonk_fixedpoint_atan<BlueprintFieldType>::input_type
                    instance_input,
                const typename plonk_fixedpoint_atan<BlueprintFieldType>::var_positions
                    &var_pos) {
            ...
            void generate_assignments_row1(
                ...
                assignment<crypto3::zk::snark::plonk_constraint_system<BlueprintFieldType>>
                    &assignment,
                const typename plonk_fixedpoint_atan<BlueprintFieldType>::var_positions &var_pos,
            ...
            template<typename BlueprintFieldType>
            typename plonk_fixedpoint_atan<BlueprintFieldType>::result_type generate_assignments(
                const plonk_fixedpoint_atan<BlueprintFieldType> &component,
                assignment<crypto3::zk::snark::plonk_constraint_system<BlueprintFieldType>>
                    &assignment,
                const typename plonk_fixedpoint_atan<BlueprintFieldType>::input_type
                ...
                return typename plonk_fixedpoint_atan<BlueprintFieldType>::result_type(
            ...
            std::size_t generate_gate0(
                ...
                using var = typename plonk_fixedpoint_atan<BlueprintFieldType>::var;
            ...
            template<typename BlueprintFieldType>
            typename plonk_fixedpoint_atan<BlueprintFieldType>::result_type generate_circuit(
                const plonk_fixedpoint_atan<BlueprintFieldType> &component,
                circuit<crypto3::zk::snark::plonk_constraint_system<BlueprintFieldType>> &bp,
                assignment<crypto3::zk::snark::plonk_constraint_system<BlueprintFieldType>>
                    &assignment,
