...
namespace nil {
    namespace blueprint {
        namespace components {
            ...
            class fix_exp<crypto3::zk::snark::plonk_constraint_system<BlueprintFieldType>,
...
// Allows disabling the lookup tables for faster testing
            ...
            template<typename BlueprintFieldType>
            typename plonk_fixedpoint_exp<BlueprintFieldType>::result_type generate_assignments(
                const plonk_fixedpoint_exp<BlueprintFieldType> &component,
                assignment<crypto3::zk::snark::plonk_constraint_system<BlueprintFieldType>>
                    &assignment,
                const typename plonk_fixedpoint_exp<BlueprintFieldType>::input_type
                    instance_input,
                ...
                // Assign rescale
                using var = typename plonk_fixedpoint_exp<BlueprintFieldType>::var;
                typename plonk_fixedpoint_exp<BlueprintFieldType>::rescale_component::input_type
                    rescale_input;
                ...
                return typename plonk_fixedpoint_exp<BlueprintFieldType>::result_type(
            ...
            std::size_t generate_lookup_gates(
                ...
                using range_table =
                    typename plonk_fixedpoint_exp<BlueprintFieldType>::range_table;
            ...
            template<typename BlueprintFieldType>
            typename plonk_fixedpoint_exp<BlueprintFieldType>::result_type generate_circuit(
                const plonk_fixedpoint_exp<BlueprintFieldType> &component,
                circuit<crypto3::zk::snark::plonk_constraint_system<BlueprintFieldType>> &bp,
                assignment<crypto3::zk::snark::plonk_constraint_system<BlueprintFieldType>>
                    &assignment,
