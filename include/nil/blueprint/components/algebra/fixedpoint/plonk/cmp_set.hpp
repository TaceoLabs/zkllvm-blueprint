...
namespace nil {
    namespace blueprint {
        namespace components {
            ...
            class fix_cmp_set<crypto3::zk::snark::plonk_constraint_system<BlueprintFieldType>,
            ...
            using plonk_fixedpoint_cmp_set =
                fix_cmp_set<crypto3::zk::snark::plonk_constraint_system<BlueprintFieldType>,
                            BlueprintFieldType, basic_non_native_policy<BlueprintFieldType>>;

            template<typename BlueprintFieldType>
            typename plonk_fixedpoint_cmp_set<BlueprintFieldType>::result_type
                generate_assignments(
                    const plonk_fixedpoint_cmp_set<BlueprintFieldType> &component,
                    assignment<crypto3::zk::snark::plonk_constraint_system<BlueprintFieldType>>
                        &assignment,
                    const typename plonk_fixedpoint_cmp_set<BlueprintFieldType>::input_type
                        instance_input,
                ...
                return typename plonk_fixedpoint_cmp_set<BlueprintFieldType>::result_type(
            ...
            std::vector<crypto3::zk::snark::plonk_constraint<BlueprintFieldType>> get_constraints(
                ...
                using var = typename plonk_fixedpoint_cmp_set<BlueprintFieldType>::var;
            ...
            template<typename BlueprintFieldType>
            typename plonk_fixedpoint_cmp_set<BlueprintFieldType>::result_type generate_circuit(
                const plonk_fixedpoint_cmp_set<BlueprintFieldType> &component,
                circuit<crypto3::zk::snark::plonk_constraint_system<BlueprintFieldType>> &bp,
                assignment<crypto3::zk::snark::plonk_constraint_system<BlueprintFieldType>>
                    &assignment,
