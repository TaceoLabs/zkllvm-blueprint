...
namespace nil {
    namespace blueprint {
        namespace components {
            ...
            class fix_max<crypto3::zk::snark::plonk_constraint_system<BlueprintFieldType>,
...
// Allows disabling the lookup tables for faster testing
            ...
            using plonk_fixedpoint_max =
                fix_max<crypto3::zk::snark::plonk_constraint_system<BlueprintFieldType>,
                        BlueprintFieldType, basic_non_native_policy<BlueprintFieldType>>;

            template<typename BlueprintFieldType>
            typename plonk_fixedpoint_max<BlueprintFieldType>::result_type generate_assignments(
                const plonk_fixedpoint_max<BlueprintFieldType> &component,
                assignment<crypto3::zk::snark::plonk_constraint_system<BlueprintFieldType>>
                    &assignment,
                const typename plonk_fixedpoint_max<BlueprintFieldType>::input_type
                    instance_input,
                ...
                return typename plonk_fixedpoint_max<BlueprintFieldType>::result_type(
            ...
            std::size_t generate_gates(
                ...
                using var = typename plonk_fixedpoint_max<BlueprintFieldType>::var;
                auto m = component.get_m();
                // Output: z = max(x, y)
            ...
            std::size_t generate_lookup_gates(
                ...
                using range_table =
                    typename plonk_fixedpoint_max<BlueprintFieldType>::range_table;
            ...
            template<typename BlueprintFieldType>
            typename plonk_fixedpoint_max<BlueprintFieldType>::result_type generate_circuit(
                const plonk_fixedpoint_max<BlueprintFieldType> &component,
                circuit<crypto3::zk::snark::plonk_constraint_system<BlueprintFieldType>> &bp,
                assignment<crypto3::zk::snark::plonk_constraint_system<BlueprintFieldType>>
                    &assignment,
