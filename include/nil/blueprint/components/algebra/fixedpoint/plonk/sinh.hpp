...
namespace nil {
    namespace blueprint {
        namespace components {
            ...
            class fix_sinh<crypto3::zk::snark::plonk_constraint_system<BlueprintFieldType>,
...
// Allows disabling lookup tables for faster testing
            ...
            using plonk_fixedpoint_sinh =
                fix_sinh<crypto3::zk::snark::plonk_constraint_system<BlueprintFieldType>,
                         BlueprintFieldType, basic_non_native_policy<BlueprintFieldType>>;

            template<typename BlueprintFieldType>
            typename plonk_fixedpoint_sinh<BlueprintFieldType>::result_type generate_assignments(
                const plonk_fixedpoint_sinh<BlueprintFieldType> &component,
                assignment<crypto3::zk::snark::plonk_constraint_system<BlueprintFieldType>>
                    &assignment,
                const typename plonk_fixedpoint_sinh<BlueprintFieldType>::input_type
                    instance_input,
                ...
                if (s_d_val == one) {
                    ...
                    return typename plonk_fixedpoint_sinh<BlueprintFieldType>::result_type(
            ...
            std::vector<crypto3::zk::snark::plonk_constraint<BlueprintFieldType>> get_constraints(
                ...
                using var = typename plonk_fixedpoint_sinh<BlueprintFieldType>::var;
                auto m2 = component.get_m2();
                auto m = component.get_m();
            ...
            std::size_t generate_lookup_gates(
                ...
                using range_table =
                    typename plonk_fixedpoint_sinh<BlueprintFieldType>::range_table;
            ...
            template<typename BlueprintFieldType>
            typename plonk_fixedpoint_sinh<BlueprintFieldType>::result_type generate_circuit(
                const plonk_fixedpoint_sinh<BlueprintFieldType> &component,
                circuit<crypto3::zk::snark::plonk_constraint_system<BlueprintFieldType>> &bp,
                assignment<crypto3::zk::snark::plonk_constraint_system<BlueprintFieldType>>
                    &assignment,
