...
namespace nil {
    namespace blueprint {
        namespace components {
            ...
            class dot_2_gates<crypto3::zk::snark::plonk_constraint_system<BlueprintFieldType>,
            ...
            using plonk_dot_2_gates =
                dot_2_gates<crypto3::zk::snark::plonk_constraint_system<BlueprintFieldType>,
                            BlueprintFieldType, basic_non_native_policy<BlueprintFieldType>>;

            template<typename BlueprintFieldType>
            typename plonk_dot_2_gates<BlueprintFieldType>::var
                get_copy_var(const plonk_dot_2_gates<BlueprintFieldType> &component,
                             std::size_t start_row_index, std::size_t dot_index, bool is_x) {
                auto pos = component.dot_position(start_row_index, dot_index, is_x);
                using var = typename plonk_dot_2_gates<BlueprintFieldType>::var;
                return var(component.W(pos.second), static_cast<int>(pos.first), false);
            }

            template<typename BlueprintFieldType>
            typename plonk_dot_2_gates<BlueprintFieldType>::result_type generate_assignments(
                const plonk_dot_2_gates<BlueprintFieldType> &component,
                assignment<crypto3::zk::snark::plonk_constraint_system<BlueprintFieldType>>
                    &assignment,
                const typename plonk_dot_2_gates<BlueprintFieldType>::input_type instance_input,
                ...
                return typename plonk_dot_2_gates<BlueprintFieldType>::result_type(
            ...
            std::size_t generate_first_gate(
                ...
                assignment<crypto3::zk::snark::plonk_constraint_system<BlueprintFieldType>>
                    &assignment,
                const typename plonk_dot_2_gates<BlueprintFieldType>::input_type
                    &instance_input) {
            ...
            template<typename BlueprintFieldType>
            typename plonk_dot_2_gates<BlueprintFieldType>::result_type generate_circuit(
                const plonk_dot_2_gates<BlueprintFieldType> &component,
                circuit<crypto3::zk::snark::plonk_constraint_system<BlueprintFieldType>> &bp,
                assignment<crypto3::zk::snark::plonk_constraint_system<BlueprintFieldType>>
                    &assignment,
