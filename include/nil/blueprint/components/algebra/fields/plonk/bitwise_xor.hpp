...
namespace nil {
    namespace blueprint {
        namespace components {
            ...
            class bitwise_xor<crypto3::zk::snark::plonk_constraint_system<BlueprintFieldType>,
...
// Allows disabling lookup tables for faster testing
            ...
            template<typename BlueprintFieldType>
            typename plonk_bitwise_xor<BlueprintFieldType>::result_type generate_assignments(
                const plonk_bitwise_xor<BlueprintFieldType> &component,
                assignment<crypto3::zk::snark::plonk_constraint_system<BlueprintFieldType>>
                    &assignment,
                const typename plonk_bitwise_xor<BlueprintFieldType>::input_type instance_input,
            ...
            std::size_t generate_lookup_gates(
                ...
                using bitwise_table =
                    typename plonk_bitwise_xor<BlueprintFieldType>::bitwise_table;
            ...
            template<typename BlueprintFieldType>
            typename plonk_bitwise_xor<BlueprintFieldType>::result_type generate_circuit(
                const plonk_bitwise_xor<BlueprintFieldType> &component,
                circuit<crypto3::zk::snark::plonk_constraint_system<BlueprintFieldType>> &bp,
                assignment<crypto3::zk::snark::plonk_constraint_system<BlueprintFieldType>>
                    &assignment,
